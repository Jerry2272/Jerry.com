...
function Footer() {
  return (
   <footer className="footerContainer p-4 ">
        <div className="footerContent">
            {/* <h1>Let Get To Know Each Other</h1> 
            <h6>I am  always open to discuss your projects | Ideas by turning them into realities. Stay connected with Jerry Jakes through my social media handles!</h6> */}
            <div className="footerIcon flex justify-center">
